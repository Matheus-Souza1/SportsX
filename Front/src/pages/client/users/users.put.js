...
function DashboardContent() {
    ...
    async function onSubmit(values, actions) {
        const response = await Api.put('/client/' + id, values);
                                    ...
                                    !data ? <p>Loading</p> :
                                        <Paper>
                                            <Formik
                                                ...
                                                onSubmit={onSubmit}
                                                initialValues={data}
                                                render={({ values, handleSubmit, setFieldValue, errors, touched, isValid }) => (
                                                    <Form>
                                                        <h1> Atualizar Cliente </h1>
                                                        <div className="client-form">
                                                            <label >Tipo de Cliente</label>
                                                            < Field name="typeClient" type="text" as="select" className="Field" onChange={(e) => {
                                                                setFieldValue(
                                                                    "typeClient",
                                                        ...
                                                        <div className="client-form">
                                                            ...
                                                            < Field name="classification" type="text" as="select" className="Field" onChange={(e) => {
                                                                setFieldValue(
                                                                    "classification",
                                                                    parseInt(e.target.value)
                                                                );
